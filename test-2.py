...
session.sendline('ip add 192.169.62.103 255.255.255.0')
result = session.expect(['#', pexpect.TIMEOUT, pexpect.EOF])
...
# Assigning an ip address to the interface
session.sendline('ip add 192.169.61.103 255.255.255.0')
result = session.expect(['#', pexpect.TIMEOUT, pexpect.EOF])
...
session.sendline('network 192.169.1.0 0.0.0.255')
